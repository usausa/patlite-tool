...
internal static partial class Log
{
    ...
    [LoggerMessage(Level = LogLevel.Information, Message = "Write success. color=[{color}], blink=[{blink}], wait=[{wait}]")]
    public static partial void InfoWriteSuccess(this ILogger logger, string color, bool blink, int wait);

    // Warning

    [LoggerMessage(Level = LogLevel.Warning, Message = "Write failed. color=[{color}], blink=[{blink}], wait=[{wait}]")]
    public static partial void WarnWriteFailed(this ILogger logger, string color, bool blink, int wait);
